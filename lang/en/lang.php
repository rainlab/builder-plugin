...
return [
    ...
    'controller' => [
        ...
        'property_behavior_reorder' => 'Reorder',
        ...
        'property_behavior_import_export_title' => 'Import / Export title',
        'property_behavior_import_export_title_required' => 'Please enter the import / export title',
        'property_behavior_import_export_name_from' => 'Attribute name',
        'property_behavior_import_export_name_from_description' => 'Model\'s attribute that should be used as a label for each record.',
        'property_behavior_import_export_name_from_required' => 'Please enter the attribute name',
        'property_behavior_import_export_model_class' => 'Model class',
        'property_behavior_import_export_model_class_description' => 'A model class name, the import / export data is loaded from this model.',
        ...
        'property_behavior_import_model_class' => 'Model class',
        'property_behavior_import_model_class_description' => 'A model class name, the list data is loaded from this model.',
        'property_behavior_import_model_placeholder' => '--select model--',
        'property_behavior_import_model_class_required' => 'Please select a model class',
        'property_behavior_import_file' => 'Import configuration file',
        'property_behavior_import_placeholder' => '--select list--',
        'property_behavior_import_file_description' => 'Reference to a Import definition file',
        ...
        'property_behavior_export_model_class' => 'Model class',
        'property_behavior_export_model_class_description' => 'A model class name, the list data is loaded from this model.',
        'property_behavior_export_model_placeholder' => '--select model--',
        'property_behavior_export_model_class_required' => 'Please select a model class',
        'property_behavior_export_file' => 'Export configuration file',
        'property_behavior_export_placeholder' => '--select list--',
        'property_behavior_export_file_description' => 'Reference to a Import definition file',
