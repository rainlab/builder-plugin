...
return [
    ...
    'components' => [
        ...
        'list_ajax_pagination' => 'Ajax pagination',
        'list_ajax_pagination_description' => 'Disabled: No ajax pagination. Replace: Standard pagination with records replacement. Append: Load More pagination with records appended. Prepend: Load more pagination with records prepended',
        'list_ajax_pagination_description_disabled' => 'Disabled',
        'list_ajax_pagination_description_replace' => 'Replace',
        'list_ajax_pagination_description_append' => 'Append',
        'list_ajax_pagination_description_prepend' => 'Prepend',
